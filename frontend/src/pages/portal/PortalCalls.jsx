...
export default function PortalCalls() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-[#17181A] tracking-tight">Llamadas</h1>
        ...
        <div className="space-y-3">
          {calls.map((call) => (
            <Link
              ...
              className="glass-card p-5 flex items-center gap-4 hover:shadow-md transition-shadow group block"
            >
