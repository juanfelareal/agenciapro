        ...
        <tr>
          <td align="center">
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 640px; background-color: #FFFFFF; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
              ...
              <tr><td style="padding: 0 40px 24px;"><p style="color: #374151; font-size: 14px; line-height: 1.6; margin: 0;">${closingBody}</p></td></tr>
              <tr><td style="padding: 0 40px 32px;">
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px;">
                  <tr><td style="padding: 20px 24px;">
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr><td style="padding: 3px 0; color: #6B7280; font-size: 13px; width: 120px;">Banco:</td><td style="padding: 3px 0; color: #111827; font-size: 13px; font-weight: 600;">Bancolombia</td></tr>
                      <tr><td style="padding: 3px 0; color: #6B7280; font-size: 13px;">Tipo de cuenta:</td><td style="padding: 3px 0; color: #111827; font-size: 13px; font-weight: 600;">Ahorros</td></tr>
                      <tr><td style="padding: 3px 0; color: #6B7280; font-size: 13px;">No. de cuenta:</td><td style="padding: 3px 0; color: #111827; font-size: 13px; font-weight: 600;">862-000036-61</td></tr>
